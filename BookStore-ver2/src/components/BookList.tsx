              ...
              <div className="p-4">
                ...
                <div className="mt-2">
                  <span className="text-gray-500 dark:text-gray-400">
                    {book.category === 'fiction' && '#นวนิยาย'}
                    {book.category === 'non-fiction' && '#สารคดี'}
                    {book.category === 'business' && '#ธุรกิจ'}
                    {book.category === 'technology' && '#เทคโนโลยี'}
                    {book.category === 'self-help' && '#พัฒนาตนเอง'}
                    {book.category === 'education' && '#การศึกษา'}
                  </span>
                </div>
                <button
